  ...
  return (
    <section className="bg-[#004047] bg-hero-image-3 bg-left-top bg-no-repeat">
      <div className="w-full h-full bg-hero-image-4 bg-no-repeat bg-right-bottom">
        <div className="container mx-auto flex flex-col gap-12 py-[120px] px-6 md:px-0 text-white">
          <div>
            <h3 className="text-white text-[32px] font-bold leading-8 text-center ">
          ...
          <div className="flex flex-col gap-12">
            {CARDS.map((card) => (
              <div
                key={card.id}
                className="flex flex-col items-center gap-4 text-center bg-quotes bg-top bg-no-repeat pt-9 "
              >
